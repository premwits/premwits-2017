...
<br />
<div class="container">
  <h5 class="center">PRE-MWITS<sup><font color="red">BETA</font></sup> <b>shop_innova</b></h5>
</div>
<form action="shop_inno.php" method="POST">
<div class="container">
  <?
    error_reporting(0);
    if($_REQUEST['inno_stat']==100)
    {
  ?>
  <div class="row">
  ...
  <?
    ...
    else if($_REQUEST['inno_stat']==700)
    {
  ?>
  <div class="row">
    ...
    <div class="card-panel s12">
      ...
      <div class="row">
        <div class="input-field col s6">
          ...
          <?
           $file_path="../json_dat/item_inno.json";
           $item_list=json_decode(file_get_contents($file_path),true);
           $item_row=count($item_list['item_inno']);
           for($i=0;$i<$item_row;$i++)
           {
          ?>
          <option value="<? echo $item_list['item_inno'][$i]['item_ino_id']; ?>"><? echo $item_list['item_inno'][$i]['name']; ?></option>
          <?
           }
          ?>
          </select>
