...
<br />
<div class="container">
  <h5 class="center">PRE-MWITS<sup><font color="red">BETA</font></sup> <b>staff</b></h5>
</div>
<form action="staff_sys.php" method="POST">
<div class="container">
  <?
    error_reporting(0);
    if($_REQUEST['st_stat']==100)
    {
  ?>
  <div class="row">
  ...
  <?
    ...
    else if($_REQUEST['st_stat']==700)
    {
  ?>
  <div class="row">
    <div class="card-panel s12 red">
      <b><h4><center><font color="white">UNEXPECTED ERROR</font></center></h4></b>
    </div>
  </div>
  <?
    }
  ...
  <div class="row">
    <div class="card-panel s12">
      ...
      <div class="row">
        <div class="input-field col s12">
          <input name="balance" id="balance" type="number" class="validate">
